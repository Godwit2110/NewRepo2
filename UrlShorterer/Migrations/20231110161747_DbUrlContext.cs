...
{
    /// <inheritdoc />
    public partial class DbUrlContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortUrls = table.Column<string>(type: "TEXT", nullable: false),
                    ContadorViews = table.Column<string>(type: "TEXT", nullable: false),
